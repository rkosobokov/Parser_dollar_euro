...
const checkPageForErrors = require('../config/checkErrors'); // использовать метод await checkPageForErrors(driver);
const checkElementsNoData = require('../config/checkElementsNoData'); // использовать метод await checkPageForErrors(driver);
